...
class Fuel_styleguide extends Fuel_advanced_module {
	
	public $name = "styleguide"; // the folder name of the module
	 ...
	 * You will be able to access it via $this->fuel->styleguide->my_method()
	 */	
